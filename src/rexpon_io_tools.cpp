...
int Init_Output_Files( rexpon_system *system, control_params *control,
...
/************************ close output files ************************/
int Close_Output_Files( rexpon_system *system, control_params *control,
                        output_controls *out_control, mpi_datatypes *mpi_data )
{
  if( out_control->write_steps > 0 )
...
void Output_Results( rexpon_system *system, control_params *control,
