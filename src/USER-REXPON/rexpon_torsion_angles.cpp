...
void Torsion_Angles( rexpon_system *system, control_params *control,
                     ...
                     rexpon_list **lists, output_controls *out_control )
{
  ...
  double p_tor2 = system->rexpon_param.gp.l[23];
  double p_tor3 = system->rexpon_param.gp.l[24];
  double p_tor4 = system->rexpon_param.gp.l[25];
  double p_cot2 = system->rexpon_param.gp.l[27];
          ...
          for( pi = start_pk; pi < end_pk; ++pi ) {
            ...
            if( bo_ij->BO > control->thb_cut/*0*/ ) {
              ...
              for( pl = start_pj; pl < end_pj; ++pl ) {
                ...
                fbh = &(system->rexpon_param.fbp[type_i][type_j]
                        [type_k][type_l]);
                fbp = &(system->rexpon_param.fbp[type_i][type_j]
                        [type_k][type_l].prm[0]);
