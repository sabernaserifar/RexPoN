...
FixStyle(rexpon/species,FixRexPoNSpecies)

#else

#ifndef LMP_FIX_REXPON_SPECIES_H
#define LMP_FIX_REXPON_SPECIES_H
...
class FixRexPoNSpecies : public Fix {
 public:
  FixRexPoNSpecies(class LAMMPS *, int, char **);
  virtual ~FixRexPoNSpecies();
  int setmask();
  virtual void init();
 ...
 protected:
  ...
  void Output_RexPoN_Bonds(bigint, FILE *);
  void create_compute();
  void create_fix();
