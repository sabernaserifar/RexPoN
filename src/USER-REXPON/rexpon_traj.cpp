...
int Write_Header( rexpon_system *system, control_params *control,
                  output_controls *out_control, mpi_datatypes *mpi_data )
{
  ...
  if( system->my_rank == MASTER_NODE ) {
    ...
    sprintf( out_control->line, REAL_LINE, "rexpon_bond_threshold:",
             control->bo_cut );
    strncat( out_control->buffer, out_control->line, HEADER_LINE_LEN+1 );
...
int Write_Init_Desc( rexpon_system *system, control_params *control,
                     output_controls *out_control, mpi_datatypes *mpi_data )
{
  ...
  for( i = 0; i < system->n; ++i ) {
    ...
    sprintf( out_control->line, INIT_DESC,
             ...
             system->rexpon_param.sbp[ p_atom->type ].mass );
...
int Init_Traj( rexpon_system *system, control_params *control,
               output_controls *out_control, mpi_datatypes *mpi_data,
               char *msg )
{
  char fname[MAX_STR];
...
int Write_Frame_Header( rexpon_system *system, control_params *control,
...
int Write_Atoms( rexpon_system *system, control_params *control,
                 output_controls *out_control, mpi_datatypes *mpi_data )
{
...
int Write_Bonds(rexpon_system *system, control_params *control, rexpon_list *bonds,
                output_controls *out_control, mpi_datatypes *mpi_data)
{
  int i, j, pj, me, np;
...
int Write_Angles( rexpon_system *system, control_params *control,
                  rexpon_list *bonds, rexpon_list *thb_intrs,
                  output_controls *out_control, mpi_datatypes *mpi_data )
{
...
int Append_Frame( rexpon_system *system, control_params *control,
                  simulation_data *data, rexpon_list **lists,
                  output_controls *out_control, mpi_datatypes *mpi_data )
{
