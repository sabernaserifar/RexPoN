...
#include "math.h"
#include "stdlib.h"
#include "angle_cross_bond_angle.h"
#include "atom.h"
#include "neighbor.h"
#include "domain.h"
#include "comm.h"
...
AngleCrossBondAngle::AngleCrossBondAngle(LAMMPS *lmp) : Angle(lmp) {}

/* ---------------------------------------------------------------------- */

AngleCrossBondAngle::~AngleCrossBondAngle()
{
  if (allocated) {
...
void AngleCrossBondAngle::compute(int eflag, int vflag)
{
  int i1,i2,i3,n,type;
  ...
  for (n = 0; n < nanglelist; n++) {
    ...
    //printf("c: %lf acos(c): %lf theta0: %lf dtheta: %lf dr1: %lf dr2: %lf energy: %lf\n",c,acos(c),theta0[type],dtheta,dr1,dr2,eangle);
...
void AngleCrossBondAngle::allocate()
{
  allocated = 1;
...
void AngleCrossBondAngle::coeff(int narg, char **arg)
{
...
double AngleCrossBondAngle::equilibrium_angle(int i)
{
  return theta0[i];
}
...
void AngleCrossBondAngle::write_restart(FILE *fp)
{
...
void AngleCrossBondAngle::read_restart(FILE *fp)
{
  allocate();
...
double AngleCrossBondAngle::single(int type, int i1, int i2, int i3)
{
  double **x = atom->x;
