...
DihedralStyle(cross/aa, DihedralCrossAngleAngle)

#else

#ifndef LMP_DIHEDRAL_CROSS_ANGLE_ANGLE_H
#define LMP_DIHEDRAL_CROSS_ANGLE_ANGLE_H
...
class DihedralCrossAngleAngle : public Dihedral {
 public:
  DihedralCrossAngleAngle(class LAMMPS *);
  ~DihedralCrossAngleAngle();
