...
#ifndef REXPON_DEFS_H
#define REXPON_DEFS_H
...
#define MAXREXPONBOND 24 /* used in fix_rexpon_bonds.cpp and pair_rexpon.cpp */
#define MAXSPECBOND 24 /* used in fix_rexpon_species.cpp and pair_rexpon.cpp */
