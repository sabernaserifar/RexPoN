...
int Init_Lookup_Tables( rexpon_system *system, control_params *control,
                        storage *workspace, mpi_datatypes *mpi_data, char *msg )
{
  ...
  num_atom_types = system->rexpon_param.num_atom_types;
...
void Deallocate_Lookup_Tables( rexpon_system *system )
{
  int i, j;
  int ntypes;

  ntypes = system->rexpon_param.num_atom_types;
