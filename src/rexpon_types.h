...
#ifndef __REXPON_TYPES_H_
#define __REXPON_TYPES_H_
...
/************* SOME DEFS - crucial for rexpon_types.h *********/

#define LAMMPS_REXPON
...
#define REXPON_MAX_STR            1024
#define REXPON_MAX_NBRS           6
#define REXPON_MAX_3BODY_PARAM    5
#define REXPON_MAX_4BODY_PARAM    5
#define REXPON_MAX_ATOM_TYPES     25
#define REXPON_MAX_MOLECULE_SIZE  20
#define MAX_BOND                    20  // same as rexponc_defs.h
...
typedef struct
{
  ...
  mpi_out_data out_buffers[REXPON_MAX_NBRS];
  void *in1_buffer;
  void *in2_buffer;
} mpi_datatypes;
...
typedef struct{
  int cnt;
  three_body_parameters prm[REXPON_MAX_3BODY_PARAM];
} three_body_header;

/* hydrogen-bond parameters */
typedef struct{
  double r0_hb, p_hb1, p_hb2, p_hb3;
  double p_hb4, p_hb5, p_hb6, p_hb7;
  double p_hb8, p_hb9, p_hb10, p_hb11;
  double p_hb12,p_hb13, p_hb14, p_hb15;
  double p_hb16, p_hb17, p_hb18, p_hb19;
  double p_hb20,p_hb21, p_hb22, p_hb23;
  double p_hb24,p_hb25, p_hb26, p_hb27;
...
{
  int cnt;
  four_body_parameters prm[REXPON_MAX_4BODY_PARAM];
} four_body_header;
...
typedef _rexpon_atom rexpon_atom;
...
struct _rexpon_system
{
  rexpon_interaction rexpon_param;
  ...
  ivec             my_coords;
  neighbor_proc    my_nbrs[REXPON_MAX_NBRS];
  int             *global_offset;
  simulation_box   big_box, my_box, my_ext_box;
  grid             my_grid;
  boundary_cutoff  bndry_cuts;
  rexpon_atom       *my_atoms;
...
typedef _rexpon_system rexpon_system;
...
typedef struct
{
  ...
  int  num_ignored;
  int  ignore[REXPON_MAX_ATOM_TYPES];
...
typedef struct
{
  ...
  double *tmp_dbl[REXPON_MAX_NBRS];
  rvec *tmp_rvec[REXPON_MAX_NBRS];
  rvec2 *tmp_rvec2[REXPON_MAX_NBRS];
  int  *within_bond_box;
...
typedef _rexpon_list  rexpon_list;
...
{
  int atom_count;
  int atom_list[REXPON_MAX_MOLECULE_SIZE];
  int mtypes[REXPON_MAX_ATOM_TYPES];
} molecule;
...
typedef void (*evolve_function)(rexpon_system*, control_params*,
                                simulation_data*, storage*, rexpon_list**,
                                output_controls*, mpi_datatypes* );

typedef void (*interaction_function) (rexpon_system*, control_params*,
                                      simulation_data*, storage*,
                                      rexpon_list**, output_controls*);

typedef void (*print_interaction)(rexpon_system*, control_params*,
                                  simulation_data*, storage*,
                                  rexpon_list**, output_controls*);

typedef double (*lookup_function)(double);

typedef void (*message_sorter) (rexpon_system*, int, int, int, mpi_out_data*);
typedef void (*unpacker) ( rexpon_system*, int, void*, int, neighbor_proc*, int );
