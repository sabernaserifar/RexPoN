...
int ReadDump::whichtype(char *str)
{
  ...
  else if (strcmp(str,"sx") == 0) type = SX;
  else if (strcmp(str,"sy") == 0) type = SY;
  else if (strcmp(str,"sz") == 0) type = SZ;
    ...
    if (replaceflag) {
      ...
      for (ifield = 1; ifield < nfield; ifield++) {
        ...
        case Z:
          ...
          break;
        case SX:
          sx[m][0] = fields[i][ifield];
          break;
        case SY:
          sx[m][1] = fields[i][ifield];
          break;
        case SZ:
          sx[m][2] = fields[i][ifield];
          break;
        case VX:
